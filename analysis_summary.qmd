...
# write.csv(words_ssc, file = "presentation/ssc.csv")
...
words_ssc2 <- words %>% 
  ...
  top_n(1, beta) %>% 
  mutate(topic = as_factor(topic))
# write.csv(words_ssc2, file = "presentation/ssc2.csv")
...
saveRDS(targets::tar_load(lda_model10_comp),"presentation/lda_model10_comp.rda")
saveRDS(targets::tar_load(lda_model10_comp),"presentation/lda_model10_ssc.rda")
