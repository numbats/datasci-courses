...
## Text Analysis - Bigram {.scrollable .smaller background-image="images/bg.jpg" background-opacity="0.5"}
...
- similar words (e.g. research finginds, designs etc.) are not grouped
...
- ANU and UQ are filtered out

- too few words left to make meaningful interpretations

:::


## Break Down by Faculty {.scrollable .smaller background-image="images/bg.jpg" background-opacity="0.5"}
...
- Data science degrees are dominated by IT at Monash, UADE, USYD and UWA
